...
if(isset($_POST['done'])){
	...
	if(mysql_query("DELETE FROM agenda WHERE id = '$idagendamento' AND dtevento = '$data' AND hora = '$hora' AND local = '$local'")) {
					if(mysql_affected_rows() == 1){
						$erro = "Atendimento desmarcado!";
					}	
				}
...
//echo '<form name="form1" action="agendapsicologo.php" method="POST" style="padding-top:10px;">';
...
$atendimento = mysql_query("SELECT * FROM agenda WHERE autor = '$nomeusuario' AND ativo = 1") or die(mysql_error());
...
?>
<center><h1>Desmarcar Atendimento</h1><br></center>
...
<table frame="box">
<tr>
<td >No. Atendimento:</td>
<td ><input readonly="readonly" name="idagendamento" type="text" class="campo" id="idagendamento" value="'.$dadosatendimento["id"].'" /></td>
</tr>
<tr>
<td >Data do Atendimento:</td>
<td ><input readonly="readonly" name="data" type="text" class="campo" id="data" value="'.$dadosatendimento["dtevento"].'" /></td>
</tr>
<tr>
