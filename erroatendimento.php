    ...
    <div id="main">
	  ...
	  <center>
        ...
        <div class="container">
			...
			<?php
	if($_SESSION['id']):
	echo 'Você só pode ter um atendimento ativo por vez. Aguarde até o término do atendimento atual para agendar outro.';
	else:
    ?>

          <p>Você precisa estar conectado ao sistema para visualizar esta página.</p>
          <div class="clear"></div>
		    <?php
			endif;
			?>
