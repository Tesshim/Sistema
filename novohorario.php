...
if(isset($_POST['horarios'])){
    ...
    $sql = mysql_query("INSERT INTO `agenda`(`evento`, `dtevento`, `autor`, `hora`, `local`, `conteudo`, `ativo`) VALUES ('$evento', '$dtevento', '$autor', '$value', '$local', '$conteudo', 1)") or die(mysql_error());
	}
            if($sql){

                $erro = "Horário cadastrado com sucesso!";
	...
	$erro = "Pelo menos um horário deve ser selecionado!";
}
}
...
a:active {
	...
	if($_SESSION['id']):
echo '
<form name="form1" action="novohorario.php" method="POST" style="padding-top:10px;">';
...
<th colspan="2">Inserir Atendimento no Calendário</th>
...
<td width="30%">Psicólogo:</td>

<td width="auto"><input type="text" readonly="readonly" name="autor" value="<?php echo $nomepsicologo["nome"]; ?>" class="campo" id="autor" /></td>
...
<td><input name="local" readonly="readonly" type="text" class="campo" id="local" value="<?php echo $nomepsicologo["campus"]; ?>" /></td>
...
<tbody>
<tr>
<td>Horários de Atendimento para a data selecionada:</td>
</tr>
</tbody>
</table>

<table border="1" width="80%"  bgcolor="#f0f0f0" style="border:1px solid #ccc; margin:0 auto; position:relative;">
<tbody>
<tr>
<td align="center"><label>07:00</label>&nbsp;&nbsp;<input type="checkbox" name="horarios[]" value="07:00"/></td>
<td align="center"><label>12:00</label>&nbsp;&nbsp;<input type="checkbox" name="horarios[]" value="12:00"/></td>
<td align="center"><label>17:00</label>&nbsp;&nbsp;<input type="checkbox" name="horarios[]" value="17:00"/></td>
</tr>
<tr>
<td align="center"><label>08:00</label>&nbsp;&nbsp;<input type="checkbox" name="horarios[]" value="08:00"/></td>
<td align="center"><label>13:00</label>&nbsp;&nbsp;<input type="checkbox" name="horarios[]" value="13:00"/></td>
<td align="center"><label>18:00</label>&nbsp;&nbsp;<input type="checkbox" name="horarios[]" value="18:00"/></td>
</tr>
<tr>
<td align="center"><label>09:00</label>&nbsp;&nbsp;<input type="checkbox" name="horarios[]" value="09:00"/></td>
<td align="center"><label>14:00</label>&nbsp;&nbsp;<input type="checkbox" name="horarios[]" value="14:00"/></td>
<td align="center"><label>19:00</label>&nbsp;&nbsp;<input type="checkbox" name="horarios[]" value="19:00"/></td>
</tr>
<tr>
<td align="center"><label>10:00</label>&nbsp;&nbsp;<input type="checkbox" name="horarios[]" value="10:00"/></td>
<td align="center"><label>15:00</label>&nbsp;&nbsp;<input type="checkbox" name="horarios[]" value="15:00"/></td>
<td align="center"><label>20:00</label>&nbsp;&nbsp;<input type="checkbox" name="horarios[]" value="20:00"/></td>
</tr>
<tr>
<td align="center"><label>11:00</label>&nbsp;&nbsp;<input type="checkbox" name="horarios[]" value="11:00"/></td>
<td align="center"><label>16:00</label>&nbsp;&nbsp;<input type="checkbox" name="horarios[]" value="16:00"/></td>
<td align="center"><label>21:00</label>&nbsp;&nbsp;<input type="checkbox" name="horarios[]" value="21:00"/></td>
</tr>
<tr>
</tbody>
</table>
...
<tbody>
<tr>
<td align="center"><input type="submit" value="Cadastrar Atendimento" /><input type="hidden" name="done" value="" /></td>
</tr>
</tbody>
</table>
