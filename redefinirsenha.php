...
<td width="auto"><input type="text" readonly="readonly" name="nome" value="<?php echo $nome["nome"]; ?>" class="campo" id="nome" /></td>
...
<td><input name="cpf" readonly="readonly" type="text" class="campo" id="cpf" value="<?php echo $cpf["cpf"]; ?>" /></td>

</tr>
<tr>


<td width="auto"><input name="pesquisar"  type="submit"  id="pesquisar" value="Pesquisar" /></td>
</tr>
