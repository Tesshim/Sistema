...
<div class="pageContent">
	...
	echo '<center><h1>Serviço de Psicologia</h1>';
	if ($nivel == 1 || $nivel == 2 || $nivel == 3 || $nivel == 4 || $nivel == 6 || $nivel == 7)
	{
		echo '<br><a href="agendar.php"><img src="images\agendar.png"></a><br>';
		...
		{
		echo'<br><a href="atendimento.php"><img src="images\visualizar.png"></a><br>';
		}
		
	}
	if ($nivel == 1 || $nivel == 8)
	{
		echo '<br><a href="visualizaratendimentos.php"><img src="images\veragendamentos.png"></a><br>';
		echo '<br><a href="agendapsicologo.php"><img src="images\desmarcar.png"></a><br>';
		echo '<br><a href="novohorario.php"><img src="images\definirhorario.png"></a><br>';
		echo '<br><a href="arquivados.php"><img src="images\arquivados.png"></a><br>';
	}
	if ($nivel == 1)
	{
		echo '<br><a href="senha.php"><img src="images\senha.png" width="277" height="57" ></a><br>';
	}
