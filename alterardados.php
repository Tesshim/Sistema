...
if(isset($_POST['done'])){
    ...
    $telefonepref = $_POST['telpref'];

    $telefonealt = $_POST['telalt'];
    ...
    $sql = mysql_query("UPDATE usuarios SET telefonepref = '$telefonepref', telefonealt = '$telefonealt', email = '$email', cidade = '$cidade', estado = '$estado' WHERE cpf = '$cpf'") or die(mysql_error());
...
echo '<form name="form1" action="alterardados.php" method="POST" style="padding-top:10px;">';
...
?>
<center><h1>Alterar Dados</h1><br></center>
<tbody>
<table>
<tr>
<td>Telefone Preferencial:</td>
<td><input name="telpref" type="text" class="campo" id="telpref" value="<?php echo $dadosusuario["telefonepref"]; ?>" /></td>
</tr>
<tr>
<td>Telefone Alternativo:</td>
<td><input name="telalt" type="text" class="campo" id="telalt" value="<?php echo $dadosusuario["telefonealt"]; ?>" /></td>
</tr>
<tr>
<td>Cidade:</td>
<td><input name="cidade" type="text" class="campo" id="cidade" value="<?php echo $dadosusuario["cidade"]; ?>" /></td>
</tr>
<tr>
<td>Estado:</td>
<td><input name="uf" type="text" class="campo" id="uf" value="<?php echo $dadosusuario["estado"]; ?>" /></td>
</tr>
</table>
</tbody>
<br>
<input name="cpf" type="hidden" class="campo" id="cpf" value="<?php echo $querycpf["cpf"]; ?>" />
<input type="hidden" name="email" type="text" class="campo" id="email" value="<?php echo $dadosusuario["email"]; ?>" />
<center><input type="submit" value="Alterar Dados" /><input type="hidden" name="done" value="" /></center>
</form>
<?php
